define({ "api": [
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "type",
            "description": "<p>调整类型 ADD(增加) SUB(减少)</p>"
          },
          {
            "group": "Parameter",
            "type": "int",
      ...
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "type": "string",
            "optional": false,
            "field": "data.leaseAdjustRequestDto.marketCenterId",
          ...
          },
          {
            ...
            "type": "string",
            "optional": false,
            "field": "data.leaseAdjustRequestDto.type",
  ...
  {
    "type": "POST",
    "url": "/v1/xlink-rent-rest/adjustLeaseRest/listListAdjustLeases",
    "title": "分页查询租约调整单",
  ...
  {
    "type": "GET",
    "url": "/v1/XLINK-RENT-REST/ChangeDeviceOrderController/listOrderStatusDetails?rentOrderId=$\\{rentOrderId\\}",
    "title": "获取直租订单状态明细列表",
    "name": "listOrderStatusDetails",
    "group": "ChangeDeviceOrderController",
    ...
    "groupTitle": "ChangeDeviceOrderController",
    "header": {
      "fields": {
        "Header": [
          {
  ...
  {
    "type": "GET",
    "url": "/v1/xlink-rent-rest/directRentOrderRest/closeDirectRentOrder/{rentOrderId}?rentOrderId=$\\{rentOrderId\\}",
    "title": "关闭直租订单",
  ...
  {
    "type": "GET",
    "url": "/v1/xlink-rent-rest/directRentOrderRest/getDirectRentOrderDetail/{rentOrderId}?rentOrderId=$\\{rentOrderId\\}",
    "title": "查询直租订单详情",
  ...
  {
    "type": "GET",
    "url": "/v1/xlink-rent-rest/directRentOrderRest/listCheckStatus/{checkId}?checkId=$\\{checkId\\}",
  ...
  {
    "type": "GET",
    "url": "/v1/XLINK-RENT-REST/ReletOrderController/getOrderAccountInfoByOrderId?rentOrderId=$\\{rentOrderId\\}",
  ...
  {
    "type": "POST",
    "url": "/v1/XLINK-RENT-REST/ReletOrderController/listExtendOrderInfo",
    "title": "获取延伸订单信息列表",
  ...
  {
    "type": "POST",
    "url": "/v1/XLINK-RENT-REST/ReletOrderController/listThrowChangeRecord",
    "title": "获取直租订单退换记录列表",
